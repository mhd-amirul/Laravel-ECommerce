              ...
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img
                    ...
                    src="{{ url('images/product-single/product-1.jpg') }}"
                    alt=""
                  />
                  <div class="zoom-icon">
                ...
                <div class="product-thumbs">
                  <div class="product-thumbs-track ps-slider owl-carousel">
                    <div
                      class="pt active"
                      data-imgbigurl="{{ url('images/product-single/product-1.jpg') }}"
                    >
                      <img src="{{ url('images/product-single/product-1.jpg') }}" alt="" />
                    </div>

                    <div
                      class="pt"
                      data-imgbigurl="{{ url('images/product-single/product-2.jpg') }}"
                    >
                      <img src="{{ url('images/product-single/product-2.jpg') }}" alt="" />
                    </div>

                    <div
                      class="pt"
                      data-imgbigurl="{{ url('images/product-single/product-3.jpg') }}"
                    >
                      <img src="{{ url('images/product-single/product-3.jpg') }}" alt="" />
                    </div>
