              ...
              <div class="col-lg-6">
                <div class="product-details">
                  ...
                  <div class="quantity">
                    ...
                    <a class="primary-btn pd-cart" onclick="shoppingCart('{{ $product->id }}', 'valueOfcart', 'change2')" style="cursor: pointer">Add To Cart</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              @if (isset($related))
                  @foreach ($related as $item)
                    <div class="product-item">
                        ...
                        <ul>
                            <li class="w-icon active" style="cursor: pointer">
